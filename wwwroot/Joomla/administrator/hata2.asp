...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="366" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="189"><p class="style9"> Admin Giriþi              </p>
            <p class="style8">&nbsp;</p>
            <form id="form1" name="form1" method="post" action="../includes/uye_kontrol.asp">
              <table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                  <td><input name="uye_sifre" type="text" class="inputbox2" id="uye_sifre" /></td>
                </tr>
                <tr>
  ...
  <tr>
    <td height="25" background="../images/admin_top2.png"><!--#include file="alt.asp"--></td>
  </tr>
</table>
<%
end if
