...
%>
<%
SQLmenu ="SELECT * FROM gop_menu where m_ust = '"& 1 &"' ORDER BY m_order asc;"
set menu = server.createobject("ADODB.Recordset")
menu.open SQLmenu , Baglanti

listemenu = 999

for zmenu=1 to listemenu
if menu.eof then exit for
%>
<%Response.Write "<ul id=""navlist""><a href="&menu("m_link")&">" & menu("m_adi") & "</a></ul>"%>
<%
menu.MoveNext
next
menu.close
