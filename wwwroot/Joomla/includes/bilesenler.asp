...
<%
component = Request.QueryString("component")
SQLekl ="SELECT * from gop_eklentiler where eklenti_k = '"& component &"';"
set ekl = server.createobject("ADODB.Recordset")
ekl.open SQLekl , Baglanti
if ekl.eof or ekl.bof then 
Response.write "<br><br><p><center>Geçersiz istekte bulundunuz.</center></p><br> "
else
