...
RadyoBilgi(4,0) = Now()-1
RadyoBilgi(4,1) = ""
End If

If DateDiff("s",RadyoBilgi(4,0),Now()) > 45 Then

Const ServerURL = "http://www.showradyo.com.tr/calansarki.asp"
Gosterim = True
