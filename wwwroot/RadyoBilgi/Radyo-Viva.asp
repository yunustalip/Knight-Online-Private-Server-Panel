...
RadyoBilgi(6,0) = Now()-1
RadyoBilgi(6,1) = ""
End If

If DateDiff("s",RadyoBilgi(6,0),Now()) > 45 Then

Const ServerURL = "http://www.radyoviva.com.tr/calansarki.asp"
Gosterim = True
