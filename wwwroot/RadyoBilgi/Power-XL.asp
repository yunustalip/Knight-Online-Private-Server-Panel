...
RadyoBilgi(12,0) = Now()-1
RadyoBilgi(12,1) = ""
End If

If DateDiff("s",RadyoBilgi(12,0),Now()) > 45 Then


Const ServerURL = "http://www.powerxl.com.tr/2010/xlsoncalan2010.asp"
Gosterim = True
...
Else
Response.Write RadyoBilgi(12,1)
End If
On Error Resume Next
%>
