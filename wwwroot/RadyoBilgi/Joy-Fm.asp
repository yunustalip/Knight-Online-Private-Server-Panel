...
RadyoBilgi(8,0) = Now()-1
RadyoBilgi(8,1) = ""
End If

If DateDiff("s",RadyoBilgi(8,0),Now()) > 45 Then

dim url
url= "http://superfm.karnaval.com/EI/SharedObjects/Handlers/ProxyHandler.ashx?url=http://triton.karnaval.com/mobile_3.xml"
...
RadyoBilgi(8,0) = Now()
RadyoBilgi(8,1) = xmlItem.childNodes(1).text&" - "&xmlItem.childNodes(0).text
Application.Lock
