...
RadyoBilgi(13,0) = Now()-1
RadyoBilgi(13,1) = ""
End If

If DateDiff("s",RadyoBilgi(13,0),Now()) > 45 Then

Const ServerURL = "http://www.radioeksen.com/song.txt"
Gosterim = True
...
Else
Response.Write RadyoBilgi(13,1)
End If
