...
RadyoBilgi(2,0) = Now()-1
RadyoBilgi(2,1) = ""
End If

If DateDiff("s",RadyoBilgi(2,0),Now()) > 45 Then

Const ServerURL = "http://www.powerturk.com/2010/Soncalan.asp"
Gosterim = True
