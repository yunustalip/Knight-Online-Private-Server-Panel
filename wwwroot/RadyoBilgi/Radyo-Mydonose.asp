...
RadyoBilgi(10,0) = Now()-1
RadyoBilgi(10,1) = ""
End If

If DateDiff("s",RadyoBilgi(10,0),Now()) > 45 Then

dim url
url= "http://superfm.karnaval.com/EI/SharedObjects/Handlers/ProxyHandler.ashx?url=http://triton.karnaval.com/mobile_5.xml"
...
RadyoBilgi(10,0) = Now()
RadyoBilgi(10,1) = xmlItem.childNodes(1).text&" - "&xmlItem.childNodes(0).text
Application.Lock
...
Else
Response.Write RadyoBilgi(10,1)
End If
%>