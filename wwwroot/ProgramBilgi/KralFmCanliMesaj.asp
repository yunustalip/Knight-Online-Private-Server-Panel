<%response.charset="utf-8"%><SCRIPT LANGUAGE="JavaScript">
               function DisBox() 
                   {
                    if(document.form.ulke.options.value = 'Turkiye')
					{  
					}
				   
                   else
                      {
						document.form.sehir.options.value = 'Diğer'
               ...
               function DisBoxx() 
                   {
                    if(!(document.form.sehir.options.value = 'Diger'))
					{  
					}
...
<table width="630" border="0"  cellpadding="10" cellspacing="3" background="images/content_bg.png" bgcolor="#FFFFFF">
	...
	<form action="http://www.kralfm.com.tr/iletisim.asp?t=studyomesaj" name="form" method="post">
				   <table width="600" border="0" cellspacing="2" cellpadding="2">
                    ...
                    <tr> 
                      <td><strong><font class="dj_title">Stüdyo'ya Mesaj</font></strong><br /><br /><center><font class="mtn1"><font style="color:#0000FF">Bu form aracılığı ile göndereceğiniz mesaj canlı yayındaki programcıya iletilecektir.<br />Canlı yayında okunacaktır.<br />Programcıya özel mesaj göndermek istiyorsanız <a href="http://www.kralfm.com.tr/iletisim.asp?t=djmesaj" class="mtn1"><font style="color:#AA0000;text-decoration:underline;">tıklayınız.</font></a></font></font></center><br /></td></tr></table>
				  
				
                  <table width="600" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                      <td width="140" align="right" class="mtn1">Adınız Soyadınız</td>
                  ...
                  <table width="600" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                      <td width="140" align="right" class="mtn1">e-posta</td>
                      <td width="10" align="center" class="mtn1">:</td>
                    ...
                    <table width="600" border="0" cellspacing="2" cellpadding="2">
                      <tr> 
                        <td width="140" align="right" class="mtn1">Telefon</td>
                        <td width="10" align="center" class="mtn1">:</td>
                    ...
                    <table width="600" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                      <td width="140" align="right" class="mtn1">mesleğiniz</td>
                      <td width="10" align="center" class="mtn1">:</td>
                  ...
                  <table width="600" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                      <td width="140" align="right" class="mtn1">şehir</td>
                      <td width="10" align="center" class="mtn1">:</td>
                    ...
                    <table width="600" border="0" cellspacing="2" cellpadding="2">
                      <tr> 
                        <td width="140" align="right" class="mtn1">ülke</td>
...
<option value="Zimbabve">Zimbabve</option></select></td>
                    ...
                    <table width="600" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                      <td width="140" align="right" class="mtn1">yaşınız</td>
                      <td width="10" align="center" class="mtn1">:</td>
                  ...
                  <table width="600" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                      <td width="140" align="right" valign="top" class="mtn1">mesajınız</td>
                      <td width="10" align="center" valign="top" class="mtn1">:</td>
                  ...
                  <table width="600" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                      <td width="140" align="right" class="mtn1">&nbsp;</td>
                      <td width="10" align="center" class="mtn1">&nbsp;</td>
