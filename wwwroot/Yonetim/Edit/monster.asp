...
<%set npcs=Conne.Execute("select knp.zoneid,knp.npcid,knp.id,k.strname,k.ssid,knp.leftx,knp.topz from k_npcpos knp, k_monster k where knp.zoneid="&zoneid&" and knp.npcid=k.ssid and acttype=1 group by knp.zoneid,knp.npcid,k.strname,k.ssid,knp.id,knp.leftx,knp.topz")
...
End If
Response.Write "<div style=""position:absolute;left:"&pxx&";top:"&pyy&"""  id=""d"&npcidx&"""><img src=""imgs/Red_Arrow_Down.gif"" width=""7"" height=""15"" id=""i"&npcidx&""" class=""screenshot"" title="""&npcs("strname")&"("
