...
set userara=Conne.Execute("select straccountid from account_char where straccountid='"&charid&"'")
if userara.eof Then
Response.End
End If
...
End If
set itemler=Conne.Execute("SELECT * FROM BANKA_CHECK WHERE straccountid='"&charid&"' order by inventoryslot")
...
Response.Write "<td width=""45"" height=""45"" id="""&itemi&"""  onclick=""selectedbox(this.id);itemozell('"&charid&"','"&itemler("inventoryslot")&"')""> "&items&"</td>"
if slot mod 6=0 Then
Response.Write "</tr><tr>"
End If

else
Response.Write "<td width=""45"" height=""45"" id="""&itemi&""" valign=""bottom"" onclick=""selectedbox(this.id);itemozell('"&charid&"','"&itemler("inventoryslot")&"')"">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>"
if slot mod 6=0 Then
Response.Write "</tr><tr>"
End If
End If
...
if sayfa>1 Then 
Response.Write "<a href=""javascript:loadpage('bankaitemleribul.asp?charid="&charid&"&sayfa="&sayfa-1&"')""><img src=""../imgs/isolok.gif"" border=""0""  align='absmiddle'></a>"
End If
for x=1 to 8
if x=cint(sayfa) Then
Response.Write "<font color=""#ffee2f"" face=""verdana"" size=""2""><b> "&x&" </b></font>"
else
Response.Write "<a href=""javascript:loadpage('bankaitemleribul.asp?charid="&charid&"&sayfa="&x&"')""><font color=""#c3cccc"" face=""verdana"" size=""2""><b> "&x&" </b></font></a>"
End If
next
if sayfa<8 Then 
Response.Write "<a href=""javascript:loadpage('bankaitemleribul.asp?charid="&charid&"&sayfa="&sayfa+1&"')""><img src=""../imgs/isagok.gif"" border=""0""  align='absmiddle'></a>"
End If
Response.Write "</td></tr>"
else
conne.Execute("delete banka_check where straccountid='"&charid&"'")
Conne.Execute("exec banka_item_decode '"&charid&"'")
Response.Redirect("?charid="&charid&"&sayfa="&Request.Querystring("sayfa"))
End If%>
<script type="text/javascript">
itemozell('<%=charid&"','"&itemi-23%>');
