...
<%
itemname=request.form("keyw")
itemtype=request.form("itemtype")
derece=request.form("derece")
cls=request.form("class")
cset=request.form("set")
...
reqcha=""
End If
Response.Write "<a href=""javascript:Sec('"&det("num")&"','"&server.htmlencode(trim(det("strname")))&"','"&det("num")&".gif"&"','"&det("countable")&"')"" onMouseOver=""return overlib('<body bgcolor=#000000><b><center><img src=../item/"&resim2(det("num"))&" width=45 height=45><br><font style=font-size:11px color="&renk&">"&server.htmlencode(det("strname"))&"<br>("&dtype&")</font><br><font color=white style=font-size:11px>"&kind&"</font><br><br></center><font color=white style=font-size:11px;>"&atack&delay&weight&duration&defans&dodging&incap&"</font><font color=lime style=font-size:11px>"&daggerac&swordac&maceac&axeAc&spearac&bowac&firedam&icedam&ligthdam&posdam&hpdrain&mpdamage&mpdrain&mirrordam&strbon&canbonus&hpbon&dexbon&intbon&mpbon&magicbon&fireres&glares&lightres&magicres&posres&curseres&"</font><font color=white style=font-size:11px>"&ReqStr&reqhp&reqdex&Reqint&Reqcha&"</font>', LEFT, WIDTH, 240,CELLPAD, 5, 10, 10);"" onMouseOut=""return nd();"">"&det("strname")&"&nbsp;&nbsp;"&det("num")&"<br></a>"
det.movenext
loop
End If
...
function Sec(num,name,rsm,dur)
{
document.getElementById('itemn').value=num;
document.getElementById('itemismi').value=name;
document.getElementById('resim').value=rsm;
}
</script>
<% End If %>