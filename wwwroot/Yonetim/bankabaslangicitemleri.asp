...
dur=Request.Querystring("dur")
stacksize=Request.Querystring("stacksize")
...
set itemozel=Conne.Execute("select * from banka_check where inventoryslot="&inventoryslot&" and straccountid='baslangic-item'")
...
Response.Redirect("bankabaslangicitemleri.asp?is=sil&num="&num&"&serial="&serial&"&dur="&dur&"&stacksize="&stacksize&"&inventoryslot="&inventoryslot)
End If
End If%>