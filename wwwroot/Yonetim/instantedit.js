...
if (actual.innerHTML=='NULL'){
actual.innerHTML='';
}
if (actual.innerHTML=='Bu Alan Boþ Býrakýlamaz !'){
actual.innerHTML='';
}
	if(height < 20){
		
	actual.innerHTML = "<input id=\""+ actual.id +"_field\" style=\"font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;width: "+width+"px; height: "+height+"px;\" maxlength=\"254\" type=\"text\" value=\"" + actual.innerHTML + "\" onkeypress=\"return fieldEnter(this,event,'" + actual.id + "')\" onfocus=\"highLight(this);\" onblur=\"noLight(this);  return fieldBlur(this,'" + actual.id + "');\" />";
		}else{
		
			
	actual.innerHTML = "<textarea name=\"textarea\" id=\""+ actual.id +"_field\" style=\"font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;width: "+width+"px; height: "+height+"px;\" onfocus=\"highLight(this);\" onblur=\"noLight(this); return fieldBlur(this,'" + actual.id + "');\">" + actual.innerHTML + "</textarea>";
		}
		changing = true;
	}
