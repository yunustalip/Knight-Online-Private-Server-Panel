...
album=replace(album," ","_")

Response.AddHeader "Content-Disposition", "inline; filename="&artist&"-"&album&".png"
...
response.clear
	...
	Response.AddHeader "Content-Disposition", "inline; filename=code.asp"
	Response.CacheControl = "no-cache"
	Response.AddHeader "Pragma", "no-cache"
	Response.Expires = -1
%>
...
'	Text, Asp, Php Gibi Uzantýlý Yazý Içerikli Dosyalarýn Içeriðini Düzenleyen Sayfa)
	...
	'Dosya içeriðine formdan yollanan yazý yazýlýyor
