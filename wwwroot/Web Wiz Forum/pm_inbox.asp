...
%></td>
 ...
 <table class="basicTable" cellspacing="0" cellpadding="3" align="center">
   <tr>
      <td colspan="2"><% Response.Write(strLoggedInUsername & ", " & strTxtYouHave & " " & intNumOfPMs & " " & strTxtPrivateMessagesYouCanReceiveAnother & " " & (intPmInbox-intNumOfPMs) & " " & strTxtOutOf & " " & intPmInbox) %></td>
     </tr>
     <tr> 
      <td>
