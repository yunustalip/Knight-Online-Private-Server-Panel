...
function sendRequest(sMode, sStatus, sMessage, sFont, sColor, sFormat, iChatroom) {
	...
	if (!isEmpty(sMode)) {				
		with (document.frmPostBack) {
			mode.value = sMode;
			status.value = sStatus;
			message.value = sMessage;
			font.value = sFont;
			color.value = sColor;
			format.value = sFormat;
			chatroom.value = iChatroom;
			submit();
		}
	}
}

//Print the postback form
document.write("<form name=\"frmPostBack\" action=\"postmessage.asp\" method=\"post\" target=\"chatUsersFrame\">");
...
document.write("<input type=\"hidden\" name=\"font\" value=\"\" />");
document.write("<input type=\"hidden\" name=\"color\" value=\"\" />");
document.write("<input type=\"hidden\" name=\"format\" value=\"\" />");
document.write("<input type=\"hidden\" name=\"chatroom\" value=\"\" />");
document.write("</form>");<%
...
Else
	...
	Response.Write(vbCrLf & "<form name=""frmFGCWebChat"" onSubmit=""postMessage();return false;"">")
	...
	Response.Write(vbCrLf & "		  </tr>")
	Response.Write(vbCrLf & "		  <tr>")
	Response.Write(vbCrLf & "		  	<td bgcolor=""" & strTableColour & """><iframe width=""100%"" height=""370"" frameborder=""0"" scrolling=""no"" src=""chatusers.asp"" name=""chatUsersFrame"" id=""cusr""></iframe></td>")
	Response.Write(vbCrLf & "		  </tr>")
	Response.Write(vbCrLf & "		  </table>")
	Response.Write(vbCrLf & "		</td>")
	...
	Response.Write(vbCrLf & "		  </tr>")
	Response.Write(vbCrLf & "		  <tr>")
	Response.Write(vbCrLf & "		  	<td class=""chatUsersTitle"" bgcolor=""" & strTableColour & """ colspan=""2""><div class=""chatBody"" id=""chatBody""></div></td>")
	Response.Write(vbCrLf & "		  </tr>")
	Response.Write(vbCrLf & "		  </table>")
	Response.Write(vbCrLf & "		</td>")
	Response.Write(vbCrLf & "	</tr>")
