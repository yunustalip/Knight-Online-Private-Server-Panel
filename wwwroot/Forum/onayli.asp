...
<IMG SRC="forumimg/ksil.gif" WIDTH="55" HEIGHT="17" BORDER="0" ALT="Konuyu ve buna ait mesajlarý siler"></a>
<%elseIf request.querystring("neresi")="cevaplar" then%>
<A HREF="?part=onayli&gorev=cevapsil&id=<%=forum("id")%>&neresi=<%=neresi%>">
<IMG SRC="forumimg/msil.gif" WIDTH="55" HEIGHT="17" BORDER="0" ALT="Sadece mesajý siler"></a>
<%End If%>
