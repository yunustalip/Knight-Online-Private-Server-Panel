...
<table border="0" width="530" id="table1" cellpadding="0" style="border-collapse: collapse" height="20">
	<tr>
		<td align="right"><img src="tema/images/rss-mini.gif"> <a href="rss.asp?rss=kategori&id=<%=id%>" target="_blank">Bu Kategoriye Ait Bloglarý Rss Ýle Takip 
		Et</a></td>
	</tr>
</table>
</center>
...
a = sayfa -1
Response.Write "<b><a href=""?kat=goster&id="&id&"&sayfa=" & a & """ title=""Önceki"">«</a></b> "
End If
...
<% else %>
<center><font class="orta"><b>Bu Kategoriye Ait Kayýt Bulunamadý.</b></font></center>
<% end if %>
					</td>
				</tr>
				<tr>
