			<table border="0" width="550" id="table1" cellpadding="0" style="border-collapse: collapse">
				<tr>
					...
					<p align="center">
					<font class="baslik"><%=Tarih%>, Tarihli Bloglar</font></td>
...
rSQL="SELECT * From blog WHERE tarih like '%"&tarih&"%'"
...
<%
If sayfa > 1 Then
response.write "<b><a href=""?ay="&ay&"&gun="&gun&"&yil="&yil&"&sayfa=1"" title=""ilk sayfa"">««</a></b> "
a = sayfa -1
Response.Write "<b><a href=""?ay="&ay&"&gun="&gun&"&yil="&yil&"&sayfa=" & a & """ title=""Önceki"">«</a></b> "
End If
...
Else
Response.Write "<b><a href=""?ay="&ay&"&gun="&gun&"&yil="&yil&"&sayfa=" & j & """>" & j & "</a><b> "
End If
Next
if Cint(sayfa) < sayfa_sayisi then
a = sayfa + 1
Response.Write "<b><a href=""?ay="&ay&"&gun="&gun&"&yil="&yil&"&sayfa=" & a & """ title=""Sonraki"">»</a></b> "
Response.Write "<b><a href=""?ay="&ay&"&gun="&gun&"&yil="&yil&"&sayfa=" & sayfa_sayisi & """ title=""Son Sayfa"">»»</a></b>"
End If
end if
%>
			</td>
...
<% else %>
<center><font class="orta"><b><%=tarih%>, Tarihli Kayýt Bulunamadý</b></font></center>
<% end if %>
					</td>
				</tr>
				<tr>
