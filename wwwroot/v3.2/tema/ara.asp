			<table border="0" width="550" id="table1" cellpadding="0" style="border-collapse: collapse">
				<tr>
					...
					<p align="center">
					<font class="baslik"><%=kelime%> Kelimesi Ýçin Sonuçlar</font></td>
...
<%
if kelime="" or Len(kelime) < 2 or Len(kelime)>43 Then
...
rSQL="SELECT * From blog WHERE Konu like '%"&kelime&"%' order by id desc" 
...
<%
If sayfa > 1 Then
response.write "<b><a href=""?ara="&kelime&"&sayfa=1"" title=""ilk sayfa"">««</a></b> "
a = sayfa -1
Response.Write "<b><a href=""?ara="&kelime&"&sayfa=" & a & """ title=""Önceki"">«</a></b> "
End If
...
Else
Response.Write "<b><a href=""?ara="&kelime&"&sayfa=" & j & """>" & j & "</a><b> "
End If
Next
if Cint(sayfa) < sayfa_sayisi then
a = sayfa + 1
Response.Write "<b><a href=""?ara="&kelime&"&sayfa=" & a & """ title=""Sonraki"">»</a></b> "
Response.Write "<b><a href=""?ara="&kelime&"&sayfa=" & sayfa_sayisi & """ title=""Son Sayfa"">»»</a></b>"
End If
end if
%>
			</td>
...
<% else %>
<center><font class="orta"><b><%=kelime%> Ýle Ýlgili Sonuç Bulunamadý.</b></font></center>
<% end if %>
					</td>
				</tr>
				<tr>
