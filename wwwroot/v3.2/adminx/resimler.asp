...
<table border="0" width="99%" id="table2" style="border-collapse: collapse" class="tablo">
	<tr>
		...
		<td height="24" class="ust" width="1080"><font class="yazi">İsim</font></td>
		<td height="24" class="ust" width="116"><font class="yazi">İşlem</font></td>
	</tr>
...
%>
	<tr>
		...
		<td width="116" height="20" class="<%=stil%>"><a href="?resim=sil&id=<%=zd_msg("id")%>" onclick="return confirm('Silmek İstediğinizden Eminmisiniz?');">Sil</a></td>
	</tr>
<%
zd_msg.movenext
	if mode=2 then
