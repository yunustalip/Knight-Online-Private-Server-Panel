...
<table border="0" width="100%" id="table1" cellpadding="0" style="border-collapse: collapse">
	<tr>
		...
		<td width="1215" background="images/bg.gif"><center><font class="baslik">Albüm Ekle</font></center></td>
...
<table width="99%" align="center" border="0" cellpadding="0" cellspacing="0" class="tablo" align="center">
	<form method="post" action="?kat=ekle">
		<tr>
			...
			<td width="70%">
			<input name="isim" type="text" size="48" class="alan"></td>
		</tr>
		<tr>
			<td width="30%">
			<div align="right">
			...
			<td width="70%"><textarea name="aciklama" class="alan" rows="6" cols="58"></textarea></td>
		</tr>
		<tr>
			<td width="30%"></td>
			<td width="70%">
