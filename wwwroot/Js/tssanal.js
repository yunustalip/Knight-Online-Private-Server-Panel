/* Virtual Keyboard added By SyMurG, http://www.turksecurity.org, info@turksecurity.org */
   ...
   function keyb_callback(ch)
   {
     ...
     {
       case "BackSpace":
         var min = (document.getElementById("pwd").value.charCodeAt(document.getElementById("pwd").value.length - 1) == 10) ? 2 : 1;
         document.getElementById("pwd").value = document.getElementById("pwd").value.substr(0, document.getElementById("pwd").value.length - min);
         break;
       ...
       default:
         document.getElementById("pwd").value += ch;
     }
    pwdgoster();
