...
Set MenuAyar=conne.Execute("select PSt from MenuAyar Where PId='DailyRanking'")
...
Set userrank = Conne.Execute("Select Top "&ksira&" Race,StrUserId,Level,Nation,Class,Loyalty,Knights,GunlukNp1,GunlukNp2 From USERDATA where "&tur&" ORDer By GunlukNp1 DESC, GunlukNp2 DESC, Level DESC, LOYALTY desc, struserid asc")
...
If siralama="karus" Then
Response.Write "<br><img src=""imgs/karusdailynp.gif"" alt="""">"
elseif siralama="elmorad" Then
Response.Write "<br><img src=""imgs/humandailynp.gif"" alt="""">"
else
Response.Write "<br><img src=""imgs/dailynp.gif"" alt="""">"
End If%>
<style type="text/css">
...
<br><br>
<br><br>
<b><a href="/Daily-Ranking" onclick="javascript:pageload('/Daily-Ranking');return false" class="link1"><img src="imgs/ortak.gif" border="0" align="texttop">&nbsp;Ortak Sýralama</a>&nbsp;-&nbsp;<a href="/Daily-Ranking/karus" onclick="javascript:pageload('/Daily-Ranking/karus');return false" class="link1"><img src="imgs/karuslogo.gif" border="0" align="texttop">&nbsp;Karus Sýralamasý</a>&nbsp;-&nbsp;<a href="/Daily-Ranking/elmorad" onclick="javascript:pageload('/Daily-Ranking/elmorad');return false" class="link1"><img src="imgs/elmologo.gif" border="0" align="absmiddle">&nbsp;Human Sýralamasý</a></b>
<br>
...
<tr bgcolor="#F3D78B" onmouseover="this.style.background='#D5AB4A'" onmouseout="this.style.background='#F3D78B'">
    ...
    <td align="center"><a href="/Daily-Ranking/<%Response.Write siralama&"/"
Response.Write cla(userrank("Class")) %>" onclick="javascript:pageload('/Daily-Ranking/<%Response.Write siralama&"/"
Response.Write cla(userrank("Class")) %>');return false" style="display:block" class="link1"><%=cla(userrank("Class"))%></a></td>
    ...
    <td align="center"><%Response.Write ayir(userrank("GunlukNp1"))&"/"&ayir(userrank("GunlukNp2"))%></td>
  </tr>
<%sira=sira+1
    userrank.MoveNext
  Loop
